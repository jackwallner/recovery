...
/// On-device record of how someone met Recharge Pro before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.recovery", category: "Conversion")
    ...
    private static let impressionPrefix = "recharge_"

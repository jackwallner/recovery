...
final class PaywallFunnelTests: XCTestCase {
    ...
    func testCountsPitchesPerSurfaceAndInTotal() {
        ConversionDiagnostics.recordPitchView(impressionID: "recharge_paywall")
        ConversionDiagnostics.recordPitchView(impressionID: "recharge_paywall")
        ConversionDiagnostics.recordPitchView(impressionID: "recharge_settings")
        ...
        XCTAssertEqual(attributes["pitch_last"], "settings")
    }
    ...
    func testConversionFreezesTheSurfaceAndCountAtTheMomentOfSale() {
        ...
        let attributes = ConversionDiagnostics.subscriberAttributes
        XCTAssertEqual(attributes["converted_surface"], "settings")
    ...
    func testAttributeKeysStayInsideRevenueCatsLimit() {
        ...
        ConversionDiagnostics.recordPitchView(impressionID: "recharge_\(long)")

...
final class RechargeUITests: XCTestCase {
    ...
    func testPaywallRendersRealProductsUnderStoreKitTesting() throws {
        ...
        XCTAssertTrue(cta.waitForExistence(timeout: 10), "the paywall CTA is missing")
        XCTAssertTrue(cta.isHittable, "the paywall CTA is not reachable without scrolling")

        attach(app, named: "paywall-layout")

        // Capture the marketing frame at a deliberate, short scroll position:
        // enough to finish the first feature explanation without leaving a
        // half-visible plan card at the top of the phone.
        ...
        attach(app, named: "paywall-short-scroll")
